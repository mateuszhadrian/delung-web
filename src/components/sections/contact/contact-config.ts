...
/** Klucz PUBLICZNY widgetu Turnstile `delung-kontakt` (sekret żyje
 *  wyłącznie w sekretach projektu Pages jako TURNSTILE_SECRET_KEY).
 *  TODO Etap 5: podmień na site key nowego widgetu dla delung.pl —
 *  placeholder poniżej celowo nie jest prawdziwym kluczem. */
export const TURNSTILE_SITE_KEY = "TODO_TURNSTILE_SITE_KEY";
