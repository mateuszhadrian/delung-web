// Ruch widoków oferty (/oferta/ i /kategorie/, część 4.3) — wspólny
// moduł obu stron, ładowany DYNAMICZNIE wyłącznie przy
...
// przed paintem) — bez JS / przy reduce strony są w pełni statyczne.
//
// Zakres: reveale [data-rev] (mobile) + parallax [data-par]
// (tła sekcji pr na /oferta/ i kt-cta na /kategorie/).
...
qa("[data-rev]").forEach((el) => {
  // Pierwszy ekran od razu (rootMargin -10% nie uznaje dolnego pasa
  // viewportu za „w kadrze" — quirk eksportu naprawiony w 4.2).
...
/* ── parallax [data-par] (wzorzec home-scroll; host = rodzic) ── */
